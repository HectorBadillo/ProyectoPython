...
ruta = Path('C:/Users/psbad/OneDrive/Documentos/Dev/Visual Studio Code/ProyectoPython/Portafolio/Video Juego')
...
# Musica
mixer.music.load(ruta/'song_fondo.mp3')
mixer.music.set_volume(0.15)
mixer.music.play(-1)

# Titulo e Icono
pygame.display.set_caption("Invasión Espacial")
icono = pygame.image.load(ruta/"ovni.png")
pygame.display.set_icon(icono)
fondo = pygame.image.load(ruta/"fondo.png")

# Puntaje
puntaje = 0
fuente_como_bytes = fuente_bytes(ruta/'FreeSansBold.ttf')
...
# Jugador
img_jugador = pygame.image.load(ruta/"nave.png")
jugador_x = 368
jugador_y = 500
jugador_x_cambio = 0
jugador_y_cambio = 0
...
for e in range(cantidad_enemigos +1 ):
    img_enemigo.append(pygame.image.load(ruta/"enemigo.png"))
...
img_bala = pygame.image.load(ruta/"bala.png")
bala_x = 0
bala_y = 584
bala_x_cambio = 0
bala_y_cambio = 3
