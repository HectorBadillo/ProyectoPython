"""
    Simulador a menos escala de 
    un sistema de caja de un 
    restaurante.
...
def recibo():
    ...
    for bebida in texto_bebida:
        if bebida.get() != '0':
            texto_recibo.insert(END, f'{lista_bebidas[x]}\t\t{bebida.get()}\t\t${round(int(bebida.get())*precios_bebida[x],2)}\n')
        x += 1
...
# Color de fondo
aplicacion.config(bg = ('AntiqueWhite2'))



#TODO: Panel superior
panel_superior = Frame(aplicacion, bd = 1, relief = FLAT, bg = 'AntiqueWhite2')
panel_superior.pack(side = TOP)
etiqueta_titulo = Label(panel_superior, text = 'Sistema de Facturacion', fg = 'azure4',
                        font = ('Dosis', 58), bg = 'AntiqueWhite2', width = 22)
etiqueta_titulo.grid(row = 0, column = 0)



#TODO: Panel izquierdo
panel_izquierdo = Frame(aplicacion, bd = 1, relief = FLAT, bg = 'AntiqueWhite2')
...
panel_comidas = LabelFrame(panel_izquierdo, text = 'Comida', font = ('Dosis', 19, 'bold'),
                            bd = 1, relief = FLAT, fg = 'azure4', bg = 'AntiqueWhite2')
...
#TODO: Panel derecho
panel_derecha = Frame(aplicacion, bd = 1, relief = FLAT,bg = 'AntiqueWhite2')
panel_derecha.pack(side = RIGHT)

# Panel calculadora
panel_calculadora = Frame(panel_derecha, bd = 1, relief = FLAT, bg = 'AntiqueWhite2')
panel_calculadora.pack()

# Panel recibo
panel_recibo = Frame(panel_derecha, bd = 1, relief = FLAT, bg = 'AntiqueWhite2')
panel_recibo.pack()

# Panel botones
panel_botones = Frame(panel_derecha, bd = 1, relief = FLAT, bg = 'AntiqueWhite2')
panel_botones.pack()



#TODO: Lista de productos
lista_comidas = ['Pollo', 'Cordero', 'Salmon', 'Res', 'Camaron', 'Atun', 'Pulpo', 'Pata']
lista_bebidas = ['Agua', 'Cocacola', 'Naranjada', 'Cerveza', 'Limonada', 'Horchata', 'Jamaica', 'Tamarindo']
lista_postres = ['Helado', 'Fruta', 'Browni', 'Flan', 'Pastel', 'Jericalla', 'Crepa', 'Gelatina']
...
for comida in lista_comidas:
    ...
    comida = Checkbutton(panel_comidas, text = comida.title(), font = ('Dosis',19,'bold'),
                            onvalue = 1, offvalue = 0, variable = variables_comida[contador],command = revisar_check, bg = 'AntiqueWhite2')
    ...
    cuadros_comida[contador] = Entry(panel_comidas, font = ('Dosis', 18, 'bold'), bd = 1,
                                        width = 6, state = DISABLED, textvariable = texto_comida[contador], disabledbackground ='AntiqueWhite3',bg = 'AntiqueWhite2')
...
for bebida in lista_bebidas:
    ...
    bebida = Checkbutton(panel_bebidas, text = bebida.title(), font = ('Dosis',19,'bold'),
                            onvalue = 1, offvalue = 0, variable = variables_bebida[contador], command = revisar_check, bg = 'AntiqueWhite2')
    ...
    cuadros_bebida[contador] = Entry(panel_bebidas, font = ('Dosis', 18, 'bold'), bd = 1,
                                        width = 6, state = DISABLED, textvariable = texto_bebida[contador], disabledbackground ='AntiqueWhite3',bg = 'AntiqueWhite2')
...
for postre in lista_postres:
    ...
    postre = Checkbutton(panel_postres, text = postre.title(), font = ('Dosis',19,'bold'),
                            onvalue = 1, offvalue = 0, variable = variables_postre[contador], command = revisar_check, bg = 'AntiqueWhite2')
    ...
    cuadros_postre[contador] = Entry(panel_postres, font = ('Dosis', 18, 'bold'), bd = 1,
                                        width = 6, state = DISABLED, textvariable = texto_postre[contador], disabledbackground ='AntiqueWhite3',bg = 'AntiqueWhite2')
...
#TODO: Etiquetas de costo y campos de entrada
# Variables
...
texto_costo_comida.configure({'readonlybackground' : 'AntiqueWhite3'})
...
texto_costo_bebida.configure({'readonlybackground' : 'AntiqueWhite3'})
...
texto_costo_postre.configure({'readonlybackground' : 'AntiqueWhite3'})
...
texto_subtotal.configure({'readonlybackground' : 'AntiqueWhite3'})
...
texto_impuestos.configure({'readonlybackground' : 'AntiqueWhite3'})
...
texto_total.configure({'readonlybackground' : 'AntiqueWhite3'})
...
for boton in botones:
    boton = Button(panel_botones, text = boton.title(), font = ('Dosis', 15, 'bold'), fg = 'white', bg = 'azure4', bd = 1, width = 8)
...
# Area de recibo
texto_recibo = Text(panel_recibo, font = ('Dosis', 12, 'bold'), bd = 1, width = 48, height = 12, bg = 'AntiqueWhite3')
texto_recibo.grid(row = 0, column = 0)



#TODO: Calculadora
visor_calculadora = Entry(panel_calculadora, font = ('Dosis', 16, 'bold'), width = 37, bd = 0.5, bg = 'AntiqueWhite3')
