...
matrix_resultado_A= Matrix(Operacion(matriz_a_obj,matriz_b_obj).producto_matrix())
matrix_resultado_B=Matrix(Operacion(matriz_a_obj,matriz_b_obj).suma_matrix())

matrix_resultado_A.imprimir()
matrix_resultado_B.imprimir()
